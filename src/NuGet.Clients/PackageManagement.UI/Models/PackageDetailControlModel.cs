...
namespace NuGet.PackageManagement.UI
{
    ...
    public class PackageDetailControlModel : DetailControlModel
    {
        ...
        protected override void CreateVersions()
        {
            ...
            var allowedVersions = _projectVersionRangeDict.Select(kvp => kvp.Value).FirstOrDefault();
            var allVersionsAllowed = allowedVersions != null ? allVersions.Where(v => allowedVersions.Satisfies(v)).ToArray() : allVersions.ToArray();
